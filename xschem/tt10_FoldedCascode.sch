...
N -980 -450 -980 -360 {
lab=GND}
C {devices/iopin.sym} -1140 -470 0 0 {name=p1 lab=VDD}
C {devices/iopin.sym} -1140 -440 0 0 {name=p2 lab=GND}
...
C {devices/lab_pin.sym} -750 -300 0 0 {name=p38 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -750 -500 0 0 {name=p39 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -720 -410 0 1 {name=p34 sig_type=std_logic lab=Vp}
C {devices/lab_pin.sym} 0 -90 0 0 {name=p15 sig_type=std_logic lab=Vc}
C {devices/lab_pin.sym} 10 -210 0 0 {name=p16 sig_type=std_logic lab=Vc}
C {devices/lab_pin.sym} -10 -350 0 0 {name=p17 sig_type=std_logic lab=Vc}
C {devices/lab_pin.sym} -930 -500 0 0 {name=p36 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -930 -300 0 0 {name=p37 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -900 -410 0 1 {name=p18 sig_type=std_logic lab=Vc}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -930 -450 0 0 {name=R5
L=5
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -930 -360 0 0 {name=R1
L=3.15
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -750 -450 0 0 {name=R2
L=5
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -750 -360 0 0 {name=R3
L=1.86
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
